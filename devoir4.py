...
# Supression des termes non voulus. 
...
# Création de la boucle qui permet d'imprimer toutes les données voulues, ici le caractère "3".
    doc = tal(mots[3])
    #for token in doc:
        #print(token.text)
        # Création de la boucle qui permet d'imprimer le texte du fichier. 
...
# Impression des 50 termes le plus fréquents dans les chroniques de Martineau.    
